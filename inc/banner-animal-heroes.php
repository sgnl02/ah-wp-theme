...
<div class="col-md-12 mobile-banner-animal-heroes">
	<?php require 'banner-button.php'; ?>

	<img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/img/banner-animal-heroes.jpg" 
